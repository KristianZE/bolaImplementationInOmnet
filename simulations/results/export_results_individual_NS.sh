...
do
    ...
    do
        ...
        opp_scavetool export -f "module=~"*router0.ppp[$sliNum]*" AND name=~"*xPk*" "  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_resAllocLink${sliNum}_vec.csv ${sourceFolder}/*-${run_num}.vec
    ...
    do
        ...
        opp_scavetool export -f "module=~"*hostVID[$cli_num]*"" -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_hostVID${cli_num}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
